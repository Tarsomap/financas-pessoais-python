    ...
    def _remover_transacao(self):
        ...
        if not selecionado:
            messagebox.showwarning("Seleção Necessária", 
                                 "Por favor, selecione uma transação para remover!")
            return
        
        # =====================================================================
        # 2. OBTÉM O ID DA TRANSAÇÃO SELECIONADA
        # =====================================================================
        # O primeiro valor da linha selecionada é o ID
        ...
        # =====================================================================
        # Pega a descrição para mostrar na mensagem de confirmação
        ...
        if confirmar:
            ...
            # =================================================================
            if self.gerenciador.remover_transacao(id_transacao):
